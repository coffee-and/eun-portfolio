...
export const projects: Project[] = [
  {
    ...
    purpose:
      "단일 심리 테스트나 운세 화면에 그치지 않고, 콘텐츠 탐색부터 결과 생성, 저장, 다시 보기, 내보내기까지 이어지는 실제 서비스 흐름을 구현했습니다.",
    role:
    ...
    scopeLabel: "결제 연동 예정",
    scopeNote:
      "핵심 콘텐츠, 계정, 결과 저장과 리포트 흐름은 구현 완료 상태입니다. 실제 유료 결제를 처리하는 결제 시스템은 아직 연동하지 않았습니다.",
  ...
  },
  {
    ...
    title: "Moment Play",
    description:
      "2048, 메모리, 스도쿠, 오목을 포함한 14종 미니게임과 랭킹·친구·초대 흐름을 제공하는 React·Supabase 기반 게임 서비스입니다.",
    detailDescription:
      "각 게임을 별도 화면으로 나열하는 데 그치지 않고, 홈, 게임 탐색, 플레이, 기록, 랭킹, 친구와 게임 초대로 이어지는 하나의 게임 플랫폼 흐름으로 구성했습니다.",
    purpose:
      "여러 장르의 게임을 공통 탐색 경험 안에서 제공하고, 플레이 전후의 기록·관계·초대 흐름까지 연결된 게임 서비스를 구현했습니다.",
    role:
      "개인 프로젝트로 서비스 기획, 게임 카탈로그 설계, 공통 레이아웃, 각 게임 UI와 로직, 사용자 흐름, Supabase 데이터 구조, 랭킹·친구·초대 기능과 테스트를 구현했습니다.",
    ...
    points: [
      ...
      "게임별 랭킹과 회원가입·로그인·온보딩 흐름을 구현했습니다.",
    ...
    scopeNote:
      "게임 플레이, 회원 흐름, 랭킹, 친구와 초대 등 핵심 게임 서비스 기능은 구현 완료 상태입니다. 실제 결제 또는 수익화 시스템은 아직 연동하지 않았습니다.",
    presentation: "featured",
    order: 2,
  ...
  },
  {
    ...
    koreanTitle: "로컬잡매치",
    description:
      "지역 기반 채용의 구직자, 고용주, 운영 관리자 흐름을 모바일 앱과 관리자 웹으로 연결한 Mock Data 기반 프로젝트입니다.",
    purpose:
      "공고 탐색과 지원에 머무르지 않고, 고용주의 공고 등록과 지원자 검토, 운영 관리자의 현황 관리까지 이어지는 채용 서비스 전체 흐름을 구현했습니다.",
    role:
    ...
    points: [
      "구직자의 공고 탐색·검색·상세 조회·지원·지원 취소와 상태별 현황 흐름을 구현했습니다.",
  ...
  },
  {
    ...
    purpose:
      "관리자, PM, 코치, 참여자의 진행 정보가 여러 문서와 도구에 흩어지는 문제를 줄이고, 코칭 프로젝트의 시작부터 성과 확인까지 하나의 서비스 흐름에서 관리하도록 구성했습니다.",
    role:
      "역할별 대시보드와 프로젝트 운영 정보 구조를 설계하고, 목표·실행·피드백·성과가 이어지는 반응형 사용자 흐름을 구현했습니다.",
    users: ["관리자", "PM", "코치", "참여자"],
    ...
    points: [
      ...
      "주간 진행률, 실행 경험, 장애 요인, 다음 계획과 코치 피드백 흐름을 연결했습니다.",
    ...
    scopeLabel: "Mock Data · YouTube 공개",
    scopeNote:
      "실제 인증, 서버와 데이터베이스 없이 예시 데이터로 전체 업무 흐름을 확인합니다. 역할 전환은 화면 미리보기이며 실제 권한 보안 기능이 아닙니다.",
    presentation: "video-demo",
    order: 4,
    repositoryNote: "Private Repository",
    ...
    videoDescription:
      "기업 코칭 프로젝트의 목표 설정, 주간 Tracking, 코치 피드백, 그룹코칭, 자료와 성과 관리를 하나의 흐름으로 연결한 운영 프로토타입입니다.",
  ...
  },
  {
    ...
    purpose:
      "학원 운영 정보가 출결표, 성적표, 공지와 상담 기록으로 흩어지는 문제를 줄이고, 원장·관리자·강사·학부모·학생이 각자 필요한 흐름을 한 서비스에서 확인하도록 구성했습니다.",
    role:
  ...
  },
  {
    ...
    purpose:
      "블록을 조립하는 경험과 실제 코드 실행 흐름 사이의 간격을 줄이고, 초보자가 각 명령의 결과를 눈으로 따라갈 수 있도록 만들었습니다.",
    role:
