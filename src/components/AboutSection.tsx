    ...
    <section className="about-editorial" id="about">
      ...
      <div className="about-editorial__profile">
        ...
        <div className="about-editorial__statement">
          <p>
            금융 서비스와 기업용 솔루션, AI 머신비전 플랫폼에서 제품을
            개발했습니다. WPF·MVVM 기반 대규모 애플리케이션의 화면 구조와
            사용성을 개선했고, 최근에는 React 서비스의 기획부터 인증, 저장,
            테스트와 배포까지 직접 맡고 있습니다.
          </p>
          <p>
            기술 이름을 많이 나열하기보다 어떤 제품에서 무엇을 맡았고, 어떤
            문제를 어떻게 개선했는지를 구체적으로 보여주는 포트폴리오를
            만들었습니다.
          </p>
        </div>
      </div>
