    ...
    <section className="youtube-section" id="videos">
      ...
      <div className="youtube-grid">
        {youtubeVideos.map((video) => {
          const detailsId = `video-details-${video.id}`;
